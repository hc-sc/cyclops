...
v_source_organism_parts_x 
as
select -- organisms with mono_code, ingred_id, source_ingred_id and with or w/o organism_id
       op.organism_name,
       op.orgtype_id,
       op.orgtype_name_eng,
       op.orgtype_name_fr,
...
union
select -- organisms with mono_code, ingred_id, source_ingred_id w/o organism_id
       op.organism_name,
       op.orgtype_id,
       op.orgtype_name_eng,
       op.orgtype_name_fr,
 ...
 where 1=1
   ...
   --and x.ingred_id = mx.ingredient_id -- ???
   and op.ingred_id = mx.source_id --ingredient_id -- vp case for ingred_id = 1548
   and x.organism_id is null and op.organism_id is null
   and op.orgparttype_id = x.orgparttype_id
union --all
