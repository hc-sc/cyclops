...
class CroppedDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            if self.opt.rgb:
                img = Image.fromarray(self.raw_images[index], 'RGB')#Image.open(self.image_path_list[index]).convert('RGB')  # for color image
            else:
                img = Image.fromarray(self.raw_images[index][:,:,0], 'L')#Image.open(self.image_path_list[index]).convert('L')
