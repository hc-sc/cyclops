 ...
 */
public class OrganismGroupDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="org_grp_class_name='NamedOrganismGroup'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public OrganismGroupDao() {
        super(OrganismGroup.class);
    }
