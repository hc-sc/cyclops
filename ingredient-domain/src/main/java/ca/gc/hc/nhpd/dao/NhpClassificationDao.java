...
/*******************************************************************************
 * An object used to retrieve instances of NhpClassification from persistent
 * store.
 * @see ca.gc.hc.nhpd.model.NhpClassification
 */
public class NhpClassificationDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="nhp_classifications";
    private final static String ID_COLUMN_NAME="nhpclass_id";
    private final static String FRENCH_COLUMN_NAME="nhpclass_name_fr";
    private final static String ENGLISH_COLUMN_NAME="nhpclass_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public NhpClassificationDao() {
        super(NhpClassification.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the NhpClassifications in the persistent
     * store. Note that these are sorted by their English names.
     * @return all instances of the NhpClassifications that are in the
     *         persistent store.
    ...
    /***************************************************************************
     * Gets the NhpClassification with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the NhpClassification in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the NhpClassification, if any, with the passed ID in the persistent
     *         store.
     */
