...
/*******************************************************************************
 * An object used to retrieve instances of MonographRouteOfAdministration from persistent store.
 * @see ca.gc.hc.nhpd.model.MonographRouteOfAdministration
 */
public class MonographRouteOfAdministrationDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MonographRouteOfAdministrationDao() {
        super(MonographRouteOfAdministration.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the MonographRouteOfAdministrations in the persistent store.
     * @return all instances of the MonographRouteOfAdministrations that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the MonographRouteOfAdministration with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the MonographRouteOfAdministration in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the MonographRouteOfAdministration, if any, with the passed ID in the persistent store.
     */
