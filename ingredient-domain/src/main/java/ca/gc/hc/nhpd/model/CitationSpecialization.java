...
/*******************************************************************************
 * An object that represents an available Citation subclass.
 * @version 1.0
 */
public class CitationSpecialization extends PersistentObject
    ...
    public int compareTo(Object o) throws ClassCastException {
        ...
        //return getName().compareTo(((CitationSpecialization)o).getName());
        return StringComparator.compare(getName(),
        								((CitationSpecialization)o).getName());
    }
    ...
    public static class FrenchComparator implements Comparator {
        ...
        public int compare(Object o1, Object o2) throws ClassCastException {
            if (o1 == null || ((CitationSpecialization)o1).getNameF() == null) {
                return 1;
            }
            if (o2 == null) {
                return -1;
            }
            return ((CitationSpecialization)o1).getNameF().compareTo(
                   ((CitationSpecialization)o2).getNameF());
        }
    }
}