 ...
 */
public class PreparationRuleDao extends AbstractDao {
    
	private static final Logger log = Logger.getLogger(PreparationRuleDao.class);
     ...
     */
    private final static String TABLE_NAME="preparation_rules";
    private final static String ID_COLUMN_NAME="preprule_id";
    private final static String FRENCH_COLUMN_NAME="preprule_name_fr";
    private final static String ENGLISH_COLUMN_NAME="preprule_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public PreparationRuleDao() {
        super(PreparationRule.class);
    }
