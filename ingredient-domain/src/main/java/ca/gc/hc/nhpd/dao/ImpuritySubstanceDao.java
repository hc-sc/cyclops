...
import ca.gc.hc.nhpd.model.ImpuritySubstance;
 ...
 */
public class ImpuritySubstanceDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public ImpuritySubstanceDao() {
        super(ImpuritySubstance.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
        ...
        return (ImpuritySubstance)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		e.printStackTrace();
    	}
