...
/*******************************************************************************
 * An object used to retrieve instances of Application Types from persistent 
 * store.
 * @see ca.gc.hc.nhpd.model.Units
 */
public class ApplicationTypeDao extends AbstractDao {
    
	private static final Logger log = Logger.getLogger(ApplicationTypeDao.class);
     ...
     */
    private final static String TABLE_NAME="application_types";
    private final static String ID_COLUMN_NAME="apptype_id";
    private final static String FRENCH_COLUMN_NAME="apptype_name_fr";
    private final static String ENGLISH_COLUMN_NAME="apptype_name_eng";
    ...
    public List findAll() throws HibernateException {
        ...
        List findAll = findByCriteria(null, order);
        
        return findAll;
    }

    /***************************************************************************
     * Gets the Solvent with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the Solvent in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the Solvent, if any, with the passed ID in the persistent store.
     */
