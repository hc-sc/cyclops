...
import ca.gc.hc.nhpd.model.Genus;
...
/*******************************************************************************
 * An object used to retrieve instances of Genus from persistent store.
 * @see ca.gc.hc.nhpd.model.Genus
 */
public class GenusDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="genera";
    private final static String ID_COLUMN_NAME="genus_id";
    private final static String FRENCH_COLUMN_NAME="genus_name";
    private final static String ENGLISH_COLUMN_NAME="genus_name";
    ...
    /***************************************************************************
     * Gets a collection of all the Genus entries in the persistent store.
     * @return all instances of Genera that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the Genus with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the Genus in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the Genus, if any, with the passed ID in the
     *         persistent store.
     */
