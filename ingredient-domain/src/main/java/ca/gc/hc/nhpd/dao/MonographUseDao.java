...
/*******************************************************************************
 * An object used to retrieve instances of MonographUse from persistent store.
 * @see ca.gc.hc.nhpd.model.MonographUse
 */
public class MonographUseDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MonographUseDao() {
        super(MonographUse.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the MonographUses in the persistent store.
     * @return all instances of the MonographUses that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the MonographUse with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the MonographUse in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the MonographUse, if any, with the passed ID in the persistent store.
     */
