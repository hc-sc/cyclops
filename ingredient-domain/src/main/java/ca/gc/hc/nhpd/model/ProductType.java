...
/*******************************************************************************
 * An object that represents a type of product.
 */
public class ProductType extends PersistentObject implements Comparable {
    private String code;
    ...
    public int compareTo(Object o) throws ClassCastException {
        ...
        if (o == null) return -1; 
    	return StringComparator.compare(getName(),((ProductType)o).getName());
    }
