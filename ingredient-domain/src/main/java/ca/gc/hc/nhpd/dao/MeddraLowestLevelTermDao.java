...
import ca.gc.hc.nhpd.model.MeddraLowestLevelTerm;

/*******************************************************************************
 * An object used to retrieve instances of Objects from persistent store for
 * testing purposes.
 */
public class MeddraLowestLevelTermDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MeddraLowestLevelTermDao() {
        super(MeddraLowestLevelTerm.class);
    }
