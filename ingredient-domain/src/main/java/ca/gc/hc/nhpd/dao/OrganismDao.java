...
public class OrganismDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="organisms";
    private final static String ID_COLUMN_NAME="organism_id";
    private final static String FRENCH_COLUMN_NAME="organism_name";
    private final static String ENGLISH_COLUMN_NAME="organism_name";
    ...
    /***************************************************************************
     * Gets a collection of all the Organisms in the persistent store.
     * @return all instances of the Organisms that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the Organism with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the Organism in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the Organism, if any, with the passed ID in the persistent store.
     */
