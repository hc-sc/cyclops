...
/*******************************************************************************
 * An object used to retrieve instances of RestrictionType from persistent
 * store.
 * @see ca.gc.hc.nhpd.model.RestrictionType
 */
public class RestrictionTypeDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="restriction_types";
    private final static String ID_COLUMN_NAME="resttype_id";
    private final static String FRENCH_COLUMN_NAME="resttype_name_fr";
    private final static String ENGLISH_COLUMN_NAME="resttype_name_eng";
    ...
    /***************************************************************************
     * Gets a collection of all the RestrictionTypes in the persistent store.
     * Note that these are sorted by their English names.
     * @return all instances of the RestrictionTypes that are in the persistent
     *         store.
    ...
    /***************************************************************************
     * Gets the Restriction Type with the passed ID from the persistent store.
     ...
     * @return the Restriction Type, if any, with the passed ID in the persistent store.
     */
