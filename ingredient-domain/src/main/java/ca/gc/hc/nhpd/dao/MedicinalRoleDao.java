...
import ca.gc.hc.nhpd.model.MedicinalRole;

/*******************************************************************************
 * An object used to retrieve instances of MedicinalRole from persistent store.
 * @see ca.gc.hc.nhpd.model.Units
 */
public class MedicinalRoleDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="rolespec_class_name='MedicinalRole'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public MedicinalRoleDao() {
        super(MedicinalRole.class);
    }
