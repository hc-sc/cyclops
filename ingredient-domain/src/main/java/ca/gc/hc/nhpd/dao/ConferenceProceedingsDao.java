...
import ca.gc.hc.nhpd.model.ConferenceProceedings;
 ...
 */
public class ConferenceProceedingsDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="citationspec_class_name='ConferenceProceedings'";
	
    /***************************************************************************
     * Generic Constructor.
     */
    public ConferenceProceedingsDao() {
        super(ConferenceProceedings.class);
    }
