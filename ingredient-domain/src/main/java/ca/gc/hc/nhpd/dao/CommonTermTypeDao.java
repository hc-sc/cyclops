...
/*******************************************************************************
 * An object used to retrieve instances of Common Term Types from persistent 
 * store.  A Common Term Type contains a collection of Common Terms.
 * @see ca.gc.hc.nhpd.model.CommonTermType
 */
public class CommonTermTypeDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="common_term_types";
    private final static String ID_COLUMN_NAME="commontermtype_id";
    private final static String FRENCH_COLUMN_NAME="commontermtype_name_fr";
    private final static String ENGLISH_COLUMN_NAME="commontermtype_name_eng";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public CommonTermTypeDao() {
        super(CommonTermType.class);
    }
