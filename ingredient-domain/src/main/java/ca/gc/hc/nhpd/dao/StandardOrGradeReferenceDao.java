 ...
 */
public class StandardOrGradeReferenceDao extends AbstractDao {
    
	private static final Logger log = Logger.getLogger(StandardOrGradeReferenceDao.class);
     ...
     */
    private final static String TABLE_NAME="standard_grade_references";
    private final static String ID_COLUMN_NAME="standgraderef_id";
    private final static String FRENCH_COLUMN_NAME=null;
    private final static String ENGLISH_COLUMN_NAME=null;
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public StandardOrGradeReferenceDao() {
        super(StandardOrGradeReference.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
    	try {
    	    return (StandardOrGradeReference)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		  e.printStackTrace();
    	}
