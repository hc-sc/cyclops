...
/*******************************************************************************
 * An object that represents an Dosage Unit.  Dosage Units are units of measure
 * that identify a quantity of product that can be taken on a periodical basis.
 * The Dosage Unit is different than the standard Unit as it contains non 
 * standard measures such as table spoon, drop, cap full, etc.
 */
public class DosageUnit extends PersistentObject 
    ...
    public int compareTo(Object o) throws ClassCastException {
        ...
        if (o == null) return -1;
    	return StringComparator.compare(getCode(),((DosageUnit)o).getCode());
