...
/*******************************************************************************
 * An object used to retrieve instances of PreparationType from
 * persistent store.
 * @see ca.gc.hc.nhpd.model.PreparationType
 */
@Component
public class PreparationTypeDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="preparation_types";
    private final static String ID_COLUMN_NAME="preptype_id";
    private final static String FRENCH_COLUMN_NAME="preptype_name_fr";
    private final static String ENGLISH_COLUMN_NAME="preptype_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public PreparationTypeDao() {
        super(PreparationType.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the PreparationTypes in the persistent
     * store. Note that these are sorted by their English names.
     * @return all instances of the PreparationTypes that are in the
     *         persistent store.
     ...
     */
    public PreparationType findByCode(String code) throws HibernateException {
    	...
    	List<PreparationType> preparationTypes = findByCriteria(criterions, null);
    	
        return preparationTypes.get(0);
       
    }
    
    /***************************************************************************
     * Gets the PreparationType with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the PreparationType in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the PreparationType, if any, with the passed ID in the persistent store.
     */
