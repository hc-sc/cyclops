...
import ca.gc.hc.nhpd.model.ChemicalSubclass;
 ...
 */
public class ChemicalSubclassDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="chem_subclasses";
    private final static String ID_COLUMN_NAME="chemsub_id";
    private final static String FRENCH_COLUMN_NAME="chemsub_fr";
    private final static String ENGLISH_COLUMN_NAME="chemsub_eng";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public ChemicalSubclassDao() {
        super(ChemicalSubclass.class);
    }
