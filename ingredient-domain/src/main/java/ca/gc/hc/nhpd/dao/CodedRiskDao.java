...
/*******************************************************************************
 * An object used to retrieve instances of CodedRisk from persistent store.
 * @see ca.gc.hc.nhpd.model.CodedRisk
 */
public class CodedRiskDao extends AbstractDao {
    ...
    /***************************************************************************
     * Gets a collection of all the CodedRisks in the persistent store.
     * @return all instances of the CodedRisks that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the CodedRisk with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the CodedRisk in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the CodedRisk, if any, with the passed ID in the persistent store.
     */
