...
import ca.gc.hc.nhpd.model.Family;
...
/*******************************************************************************
 * An object used to retrieve instances of Family from persistent store.
 * @see ca.gc.hc.nhpd.model.Family
 */
public class FamilyDao extends AbstractDao {	
     ...
     */
    private final static String TABLE_NAME="families";
    private final static String ID_COLUMN_NAME="family_id";
    private final static String FRENCH_COLUMN_NAME="family_name";
    private final static String ENGLISH_COLUMN_NAME="family_name";
    ...
    /***************************************************************************
     * Gets a collection of all the Family entries in the persistent store.
     * @return all instances of Families that are in the persistent store.
    ...
    /***************************************************************************
     * Gets the Family with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the Family in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the Family, if any, with the passed ID in the persistent store.
     */
