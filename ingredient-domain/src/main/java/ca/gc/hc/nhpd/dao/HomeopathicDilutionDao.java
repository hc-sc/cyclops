...
/*******************************************************************************
 * An object used to retrieve instances of HomeopathicDilution from persistent store.
 */
public class HomeopathicDilutionDao extends AbstractDao {
    
    private static final Logger log = Logger.getLogger(HomeopathicDilutionDao.class);
    ...
    private final static String DISCRIMINATOR="ingredspec_class_name='HomeopathicDilution'";
    
  
    /***************************************************************************
     * Generic Constructor.
     */
    public HomeopathicDilutionDao() {
        super(HomeopathicDilution.class);
    }
