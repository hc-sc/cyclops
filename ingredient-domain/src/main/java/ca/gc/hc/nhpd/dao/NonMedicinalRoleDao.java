...
/*******************************************************************************
 * An object used to retrieve instances of NonMedicinalRole from persistent store.
 * @see ca.gc.hc.nhpd.model.Units
 */
public class NonMedicinalRoleDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="rolespec_class_name='NonMedicinalRole'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public NonMedicinalRoleDao() {
        super(NonMedicinalRole.class);
    }
