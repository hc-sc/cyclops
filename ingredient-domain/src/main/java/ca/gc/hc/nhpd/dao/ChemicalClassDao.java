...
import ca.gc.hc.nhpd.model.ChemicalClass;
...
/*******************************************************************************
 * An object used to retrieve instances of ChemicalClass from persistent store.
 * @see ca.gc.hc.nhpd.model.ChemicalClass
 */
public class ChemicalClassDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="chem_classes";
    private final static String ID_COLUMN_NAME="chemcl_id";
    private final static String FRENCH_COLUMN_NAME="chemcl_name_fr";
    private final static String ENGLISH_COLUMN_NAME="chemcl_name_eng";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public ChemicalClassDao() {
        super(ChemicalClass.class);
    }
    ...
    /***************************************************************************
     * Gets the ChemicalClass with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the ChemicalClass in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the ChemicalClass, if any, with the passed ID in the persistent
     *         store.
     */
