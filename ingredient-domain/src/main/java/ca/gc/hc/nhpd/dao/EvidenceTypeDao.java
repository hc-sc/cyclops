...
import ca.gc.hc.nhpd.model.EvidenceType;
...
/*******************************************************************************
 * An object used to retrieve instances of EvidenceType from persistent store.
 * @see ca.gc.hc.nhpd.model.EvidenceType
 */
public class EvidenceTypeDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="evidence_types";
    private final static String ID_COLUMN_NAME="evidtype_id";
    private final static String FRENCH_COLUMN_NAME="evidtype_name_fr";
    private final static String ENGLISH_COLUMN_NAME="evidtype_name_eng";
    ...
    /***************************************************************************
     * Gets a collection of all the EvidenceTypes in the persistent store.
     * Note that these are sorted by their English names.
     * @return all instances of the EvidenceTypes that are in the persistent
     *         store.
    ...
    /***************************************************************************
     * Gets the EvidenceType with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the EvidenceType in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the EvidenceType, if any, with the passed ID in the persistent store.
     */
