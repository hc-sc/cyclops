...
/*******************************************************************************
 * An object used to retrieve instances of MonographEntry from persistent store.
 *
 * @see  ca.gc.hc.nhpd.model.MonographEntry
 */
public class MonographEntryDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MonographEntryDao() {
        super(MonographEntry.class);
    }

    //~ public -----------------------------------------------------------------

    /**
     * Gets a collection of all the MonographEntry in the persistent store.
     *
     * @return  all instances of the MonographEntry that are in the persistent
     *          store.
     *
    ...
    /**
     * Gets the MonographEntry with the passed ID from the persistent store.
     * Returns null if none is found.
     *
     * @param   id    the unique key of the MonographEntry in the persistent
     *                store.
     * @param   lock  true if the corresponding record should automatically be
     *                locked from updates in the persistent store.
     *
     * @return  the MonographEntry, if any, with the passed ID in the persistent
     *          store.
     */
