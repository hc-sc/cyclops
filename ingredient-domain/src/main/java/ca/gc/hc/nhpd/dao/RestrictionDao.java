 ...
 */
public class RestrictionDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="restrictions";
    private final static String ID_COLUMN_NAME="restrict_id";
    private final static String FRENCH_COLUMN_NAME="restrict_detail_fr";
    private final static String ENGLISH_COLUMN_NAME="restrict_detail_eng";
