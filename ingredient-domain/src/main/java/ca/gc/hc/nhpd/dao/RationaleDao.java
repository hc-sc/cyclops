...
import ca.gc.hc.nhpd.model.Rationale;
 ...
 */
public class RationaleDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="rationales";
    private final static String ID_COLUMN_NAME="rationale_id";
    private final static String FRENCH_COLUMN_NAME="notes_fr";
    private final static String ENGLISH_COLUMN_NAME="notes_eng";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public RationaleDao() {
        super(Rationale.class);
    }
