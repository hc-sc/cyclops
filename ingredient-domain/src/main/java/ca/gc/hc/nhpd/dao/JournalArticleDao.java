...
import ca.gc.hc.nhpd.model.JournalArticle;
 ...
 */
public class JournalArticleDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="citationspec_class_name='JournalArticle'";
	
    /***************************************************************************
     * Generic Constructor.
     */
    public JournalArticleDao() {
