...
import ca.gc.hc.nhpd.model.BookChapter;
 ...
 */
public class BookChapterDao extends AbstractDao {
    ...
    private final static String DISCRIMINATOR="citationspec_class_name='BookChapter'";
