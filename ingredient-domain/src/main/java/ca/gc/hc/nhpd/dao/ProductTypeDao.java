...
import ca.gc.hc.nhpd.model.ProductType;
...
/*******************************************************************************
 * An object used to retrieve instances of PartPreparation from
 * persistent store.
 * @see ca.gc.hc.nhpd.model.PartPreparation
 */
public class ProductTypeDao extends AbstractDao {
    ...
    /***************************************************************************
     * Gets a collection of all the PartPreparations in the persistent
     * store. Note that these are sorted by their English names.
     * @return all instances of the PartPreparations that are in the
     *         persistent store.
    ...
    /***************************************************************************
     * Gets the PartPreparation with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the PartPreparation in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the PartPreparation, if any, with the passed ID in the persistent store.
     */
