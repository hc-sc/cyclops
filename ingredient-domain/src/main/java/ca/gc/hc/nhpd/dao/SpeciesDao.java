...
import ca.gc.hc.nhpd.model.Species;
...
/*******************************************************************************
 * An object used to retrieve instances of Species from persistent store.
 * @see ca.gc.hc.nhpd.model.Species
 */
public class SpeciesDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="species_mv";
    ...
    private final static String DISCRIMINATOR="";
    ...
    /***************************************************************************
     * Gets a collection of all the Species entries in the persistent store.
    ...
    /***************************************************************************
     * Gets the Species with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the Species in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the Species, if any, with the passed ID in the
     *         persistent store.
     */
