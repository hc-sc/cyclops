...
import ca.gc.hc.nhpd.model.QuantityToleranceModel;
 ...
 */
public class QuantityToleranceModelDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="quality_tolerance_models";
    private final static String ID_COLUMN_NAME="qualitymodel_id";
    private final static String FRENCH_COLUMN_NAME="qualitymodel_name_fr";
    private final static String ENGLISH_COLUMN_NAME="qualitymodel_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public QuantityToleranceModelDao() {
        super(QuantityToleranceModel.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
        ...
        return (QuantityToleranceModel)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		e.printStackTrace();
    	}
