...
import ca.gc.hc.nhpd.model.BasicImpuritySubstance;
 ...
 */
public class BasicImpuritySubstanceDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public BasicImpuritySubstanceDao() {
        super(BasicImpuritySubstance.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
        ...
        return (BasicImpuritySubstance)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		e.printStackTrace();
    	}
