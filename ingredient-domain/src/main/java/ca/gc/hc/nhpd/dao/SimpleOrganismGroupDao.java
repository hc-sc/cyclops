 ...
 */
public class SimpleOrganismGroupDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="organism_groups";
    private final static String ID_COLUMN_NAME="org_grp_id";
    private final static String FRENCH_COLUMN_NAME="org_grp_name_fr";
    private final static String ENGLISH_COLUMN_NAME="org_grp_name_eng";
    private final static String DISCRIMINATOR="org_grp_class_name='SimpleOrganismGroup'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public SimpleOrganismGroupDao() {
        super(SimpleOrganismGroup.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the SimpleOrganismGroups in the persistent store.
    ...
    /***************************************************************************
     * Gets the SimpleOrganismGroup with the passed ID from the persistent store.
