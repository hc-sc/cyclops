...
import ca.gc.hc.nhpd.model.MeddraHighLevelTerm;

/*******************************************************************************
 * An object used to retrieve instances of Objects from persistent store for
 * testing purposes.
 */
public class MeddraHighLevelTermDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MeddraHighLevelTermDao() {
        super(MeddraHighLevelTerm.class);
    }
