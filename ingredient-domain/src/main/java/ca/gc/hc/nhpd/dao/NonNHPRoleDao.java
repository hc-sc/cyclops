...
import ca.gc.hc.nhpd.model.NonNHPRole;
 ...
 */
public class NonNHPRoleDao extends AbstractDao {
    
	private static final Logger log = Logger.getLogger(NonNHPRoleDao.class);
    ...
    private final static String DISCRIMINATOR="rolespec_class_name='NonNHPRole'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public NonNHPRoleDao() {
        super(NonNHPRole.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
    	try {
    	    return (NonNHPRole)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		  e.printStackTrace();
    	}
