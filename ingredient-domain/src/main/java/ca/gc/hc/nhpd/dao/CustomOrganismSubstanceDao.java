 ...
 */
public class CustomOrganismSubstanceDao extends AbstractDao {
    
    private static final Logger log = Logger.getLogger(CustomOrganismSubstanceDao.class);
    ...
    private final static String DISCRIMINATOR="ingredspec_class_name='CustomOrganismSubstance'";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public CustomOrganismSubstanceDao() {
        super(CustomOrganismSubstance.class);
    }
