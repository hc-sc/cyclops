 ...
 */
public class PreparationTypeGroupDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="preparation_type_groups";
    private final static String ID_COLUMN_NAME="preptypegrp_id";
    private final static String FRENCH_COLUMN_NAME="preptypegrp_name_fr";
    private final static String ENGLISH_COLUMN_NAME="preptypegrp_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public PreparationTypeGroupDao() {
        super(PreparationTypeGroup.class);
    }
