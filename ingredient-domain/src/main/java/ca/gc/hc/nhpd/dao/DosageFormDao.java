...
/*******************************************************************************
 * An object used to retrieve instances of DosageForm from persistent store.
 * @see ca.gc.hc.nhpd.model.DosageForm
 */
@Component
public class DosageFormDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="dosage_forms";
    private final static String ID_COLUMN_NAME="dosefrm_id";
    private final static String FRENCH_COLUMN_NAME="dosefrm_name_fr";
    private final static String ENGLISH_COLUMN_NAME="dosefrm_name_eng";
    
    /***************************************************************************
     * Generic Constructor.
     */
    public DosageFormDao() {
    ...
    /***************************************************************************
     * Gets a collection of all the DosageForms in the persistent
    ...
    /***************************************************************************
     * Gets the DosageForm with the passed ID from the persistent store.
