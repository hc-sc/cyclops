...
import ca.gc.hc.nhpd.model.MeddraSystemOrganClass;

/*******************************************************************************
 * An object used to retrieve instances of Objects from persistent store for
 * testing purposes.
 */
public class MeddraSystemOrganClassDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public MeddraSystemOrganClassDao() {
        super(MeddraSystemOrganClass.class);
    }
