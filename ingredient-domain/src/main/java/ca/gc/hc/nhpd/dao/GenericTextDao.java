 ...
 */
public class GenericTextDao extends AbstractDao {
    
	private static final Logger log = Logger.getLogger(GenericTextDao.class);
     ...
     * Generic Constructor.
     */
    public GenericTextDao() {
        super(GenericText.class);
    }
    ...
    public Object findById(Long id, boolean lock) {
    	try {
    	    return (GenericText)super.findByIdBase(id, lock);
    	} catch ( Exception e ) {
    		  e.printStackTrace();
    	}
