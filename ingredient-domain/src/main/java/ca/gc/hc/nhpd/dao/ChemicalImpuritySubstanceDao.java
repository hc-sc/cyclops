...
import ca.gc.hc.nhpd.model.ChemicalImpuritySubstance;

/*******************************************************************************
 * An object used to retrieve instances of Units from persistent store.
 * @see ChemicalImpuritySubstance
 */
public class ChemicalImpuritySubstanceDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public ChemicalImpuritySubstanceDao() {
        super(ChemicalImpuritySubstance.class);
    }
