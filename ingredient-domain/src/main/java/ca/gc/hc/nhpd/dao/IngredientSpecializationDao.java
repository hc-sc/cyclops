...
import ca.gc.hc.nhpd.model.IngredientSpecialization;
...
/*******************************************************************************
 * An object used to retrieve instances of IngredientSpecialization from
 * persistent store.
 * @see ca.gc.hc.nhpd.model.IngredientSpecialization
 */
public class IngredientSpecializationDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="ingredient_specials";
    private final static String ID_COLUMN_NAME="ingredspec_id";
    private final static String FRENCH_COLUMN_NAME="ingredspec_name_fr";
    private final static String ENGLISH_COLUMN_NAME="ingredspec_name_eng";
    private final static String DISCRIMINATOR=null;
    
    /***************************************************************************
     * Generic Constructor.
     */
    public IngredientSpecializationDao() {
        super(IngredientSpecialization.class);
    }
    ...
    /***************************************************************************
     * Gets the IngredientSpecialization with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the IngredientSpecialization in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the IngredientSpecialization, if any, with the passed ID in the persistent store.
     */
