...
import ca.gc.hc.nhpd.model.CitationSpecialization;
...
/*******************************************************************************
 * An object used to retrieve instances of CitationSpecialization from
 * persistent store.
 * @see ca.gc.hc.nhpd.model.CitationSpecialization
 */
public class CitationSpecializationDao extends AbstractDao {
     ...
     * Generic Constructor.
     */
    public CitationSpecializationDao() {
        super(CitationSpecialization.class);
    }
    ...
    /***************************************************************************
     * Gets a collection of all the CitationSpecializations in the persistent
     * store. Note that these are sorted by their English names.
     * @return all instances of the CitationSpecializations that are in the
     *         persistent store.
