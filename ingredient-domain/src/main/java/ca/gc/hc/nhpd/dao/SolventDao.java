...
/*******************************************************************************
 * An object used to retrieve instances of Solvents from persistent store.
 * @see ca.gc.hc.nhpd.model.IchClass
 */
@Component
public class SolventDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="solvents";
    private final static String ID_COLUMN_NAME="solvents_id";
    private final static String FRENCH_COLUMN_NAME="solvents_name_fr";
    private final static String ENGLISH_COLUMN_NAME="solvents_name_eng";
    ...
    /***************************************************************************
     * Gets a collection of all the Solvents in the persistent store.
     * Note that these are sorted by their English names.
     * @return all instances of the Solvents that are in the persistent
     *         store.
