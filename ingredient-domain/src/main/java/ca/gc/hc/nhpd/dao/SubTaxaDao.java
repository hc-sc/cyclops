...
import ca.gc.hc.nhpd.model.SubTaxa;
...
/*******************************************************************************
 * An object used to retrieve instances of SubSpecies from persistent store.
 * @see ca.gc.hc.nhpd.model.SubSpecies
 */
public class SubTaxaDao extends AbstractDao {
     ...
     */
    private final static String TABLE_NAME="subtaxa_mv";
    ...
    /***************************************************************************
     * Gets a collection of all the SubSpecies entries in the persistent store.
    ...
    /***************************************************************************
     * Gets the SubSpecies with the passed ID from the persistent store.
     * Returns null if none is found.
     * @param id the unique key of the SubSpecies in the persistent store.
     * @param lock true if the corresponding record should automatically be
     *        locked from updates in the persistent store.
     * @return the SubSpecies, if any, with the passed ID in the
     *         persistent store.
     */
