 ...
 * Monograph Web Service specific configuration properties  
 */
public class MonographServicePropertyManager {

	private static final Log log = LogFactory.getLog(MonographServicePropertyManager.class);
	...
	public static final int DEFAULT_PLA_MAX_SEARCH_RESULTS_SIZE = 200;
	public static final String DEFAULT_INGREDIENT_DB_URL = 
		"http://oeuf/nhpid-bdipsn/";
	...
	private static void generateDefaults() {
		...
		MonographServicePropertyManager.configurationProperties = configurationProperties;
	}	
